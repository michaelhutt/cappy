#############################################################################
# Makefile for building: cappy
# Generated by qmake (2.01a) (Qt 4.6.2) on: Tue Nov 12 11:33:21 2013
# Project:  cappy.pro
# Template: subdirs
# Command: /usr/lib64/qt4/bin/qmake -unix -o Makefile cappy.pro
#############################################################################
...
src/$(MAKEFILE): 
	...
	cd src/ && $(QMAKE) /home/huttmr/offtopic/qcap2/src/src.pro -unix -o $(MAKEFILE)
...
Makefile: cappy.pro  /usr/lib64/qt4/mkspecs/linux-g++-64/qmake.conf /usr/lib64/qt4/mkspecs/common/g++-multilib.conf \
	...
	$(QMAKE) -unix -o Makefile cappy.pro
